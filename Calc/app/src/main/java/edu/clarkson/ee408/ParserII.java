                ...
                while (!emptyOpr() && t.precedence<=topPrecedence()&&(t.type==7 || topOpr()!=6)){
                    ...
                    if (op==0 || op==1 || op==2 || op==3){
                        ...
                        switch (op){
                            case 0:
                                result1 = op1+op2;
                                //KAB added to throw Overflow Exception
                                try{
                                    result1 = Math.addExact(op1, op2);
                                }
                                catch (Exception ex){
                            ...
                            case 1:
                                result1 = op1-op2;
                                //KAB added to throw Overflow/Underflow Exception
                                try{
                                    result1 = Math.subtractExact(op1, op2);
                                }
                                catch (Exception ex){
                            ...
                            case 2:
                                ...
                                //KAB added to throw Overflow/Underflow Exception
                                try{
                                    result1 = Math.multiplyExact(op1, op2);
                                }
