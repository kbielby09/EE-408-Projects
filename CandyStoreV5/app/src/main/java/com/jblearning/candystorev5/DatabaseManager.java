...
public class DatabaseManager extends SQLiteOpenHelper {
  ...
  public void onCreate( SQLiteDatabase db ) {
    ...
    db.execSQL("create table transactions (total real)");
  }
  ...
  public void insertTotal ( double total ) {
    SQLiteDatabase db = this.getWritableDatabase( );
    String sqlInsert = "insert into transactions values(" + total +")";

    db.execSQL( sqlInsert );
    db.close( );
  }

  /////////////////// Function used to Delete previous transactions for new year ///////////////////
  ...
  public double getTotal() {
    String sqlQuery = "select sum(total) from transactions ";
